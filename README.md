...
### Solutions Engineer | Technical Implementation | AI Automation & API Integrations

**Founder of [PertoDaqui](https://pertodaqui.pt) & [MargInData](https://margindata.pt)**

I build practical production systems that connect APIs, automate workflows, process data, and help teams operate more efficiently.

My work focuses on backend services, serverless/edge systems, operational dashboards, AI-assisted workflows, secure data handling, and technical implementation for real business processes.
...
<p align="left">
  <img src="https://img.shields.io/badge/APIs-REST%20%7C%20Webhooks%20%7C%20Auth-2F80ED?style=flat-square" alt="APIs badge" />
...
| Area                          | Examples                                                      |
| :---------------------------- | :------------------------------------------------------------ |
| **API & Integration Systems** | REST APIs, webhooks, authentication, third-party integrations |
| **AI Workflow Automation**    | LLM workflows, OCR, transcription, structured data extraction |
| **Operational Dashboards**    | Admin tools, internal interfaces, logs, audit trails          |
| **Edge & Serverless Systems** | Cloudflare Workers, D1, R2, serverless APIs                   |
| **Technical Implementation**  | Turning business workflows into reliable technical systems    |

---

## Selected Work

### [PertoDaqui](https://pertodaqui.pt)
